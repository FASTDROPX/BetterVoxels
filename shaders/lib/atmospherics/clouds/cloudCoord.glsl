    ...
    vec3 ModifyTracePos(vec3 tracePos, int cloudAltitude) {
            ...
            float wind = frameTimeCounter * CLOUD_SPEED_MULT_M;
                ...
                // Iteration 34: restored Iteration 31 structure. Custom cloud
                // speed stays real-time (frameTimeCounter) normally, but warps
                // onto the eased world-visual clock during a transition.
